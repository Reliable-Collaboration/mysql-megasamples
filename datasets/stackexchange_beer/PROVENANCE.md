...
|---|---:|---|
| `stackexchange_beer/beer.stackexchange.com.7z` | 4,317,770 | `29e057c640ad2792c8fc063d3ef52e6d2ce397db995a8ca5a06f1735a82d84c2` |
...
Converted by [`datasets/stackexchange_beer/convert.py`](convert.py). beer.stackexchange.com (archive.org 2024-04-02 snapshot) -> MySQL.
...
11 tables, 62,523 rows. Per-table counts, digests, index sets,
