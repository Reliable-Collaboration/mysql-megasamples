...
CREATE VIRTUAL TABLE "supplementary_demographics_sup_text_idx_fts" USING fts5("comments", content='supplementary_demographics', content_rowid='rowid');
CREATE TRIGGER "supplementary_demographics_sup_text_idx_fts_ai" AFTER INSERT ON "supplementary_demographics" BEGIN
  INSERT INTO "supplementary_demographics_sup_text_idx_fts"(rowid, "comments") VALUES (NEW.rowid, NEW."comments");
END;
CREATE TRIGGER "supplementary_demographics_sup_text_idx_fts_ad" AFTER DELETE ON "supplementary_demographics" BEGIN
  INSERT INTO "supplementary_demographics_sup_text_idx_fts"("supplementary_demographics_sup_text_idx_fts", rowid, "comments") VALUES ('delete', OLD.rowid, OLD."comments");
END;
CREATE TRIGGER "supplementary_demographics_sup_text_idx_fts_au" AFTER UPDATE ON "supplementary_demographics" BEGIN
  INSERT INTO "supplementary_demographics_sup_text_idx_fts"("supplementary_demographics_sup_text_idx_fts", rowid, "comments") VALUES ('delete', OLD.rowid, OLD."comments");
  INSERT INTO "supplementary_demographics_sup_text_idx_fts"(rowid, "comments") VALUES (NEW.rowid, NEW."comments");
END;
INSERT INTO "supplementary_demographics_sup_text_idx_fts"("supplementary_demographics_sup_text_idx_fts") VALUES ('rebuild');
