...
* Checksum: none published; the executor records `sha256sum` of the pinned blob at first download ([source record](/sources/github-microsoft-sql-server-samples-instnwnd-sql.md)).
