...
Input is what `scripts/wwi_export.py` wrote: `meta.json` (the SQL Server catalogue), `baseline.json`
...
import tsql            # the project's identifier rule: lower case, spaces to underscores,
...
-- scripts/wwi_export.py takes out of Microsoft's .bak. Upstream: microsoft/sql-server-samples (MIT).
