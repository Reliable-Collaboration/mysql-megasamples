...
"""Assert that nothing which may not be redistributed is in the repository, the image or the release.
  ...
  python3 scripts/audit_assets.py [--image mysql-megasamples:dev]

PLAN.md section 8.3 items 4, 5 and 6, run as one check because they are one question: did anything
